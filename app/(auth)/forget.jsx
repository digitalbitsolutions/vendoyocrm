...
export default function Forget() {
  ...
  return (
    <ImageBackground source={BG} style={s.bg} resizeMode="cover">
      {/* Scrim más oscuro en dark para contraste */}
      <View
        style={[
          s.scrim,
              ...
              {sent && (
                <InlineMessage type="success" style={{ marginBottom: theme.spacing.md }}>
                  <Text>
                    ...
                    <Text style={{ fontWeight: "700" }}>{emailSentTo}</Text>. Revisa tu bandeja de
                    entrada o spam.
                  </Text>
                </InlineMessage>
              )}
                ...
                onSubmit={async (values, helpers) => {
                  ...
                  try {
                    ...
                    helpers.setFieldError(
                      "email",
                      e?.message || "No pudimos enviar el correo. Inténtalo más tarde."
                    );
                  }
                }}
              >
                {({
                  ...
                  <>
                    ...
                    <Button
                      ...
                      disabled={isSubmitting || !values.email || !!errors.email || cooldown > 0}
                      variant="primary"
                      fullWidth
                    />
